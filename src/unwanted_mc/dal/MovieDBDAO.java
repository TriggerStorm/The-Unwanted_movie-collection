...
public class MovieDBDAO {
    ...
    /**
     * gets the vallue of the table moives in the db and add to a list
     * allMovies.
     *
     * @return
     * @throws SQLException
    ...
    /**
     * gets all movies and checks if the rating is below and extenden the date
     * value. and returns a list of movies to delete
     *
     * @return
     * @throws SQLException
     */
    ...
    /**
     * test if the value of last viewd is extenden date and return a list
     * overTwoYears.
     *
     * @param id
     * @return
